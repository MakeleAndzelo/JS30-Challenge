    ...
    // const elements = document.querySelector('.mw-category');
    // const links = Array.from(elements.querySelectorAll('a'));
    ...
    const reducesData = data.reduce((obj, item) => {
      if(!obj[item]) {
        obj[item] = 0
      }
      obj[item]++;
